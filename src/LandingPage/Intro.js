        ...
        <Grid container spacing={10} className={classes.sectionMargin}>
          ...
          >
            ...
            <Typography variant="body1" className={classes.marginParagraph}>
              Venture from the bucolic North Island to the Southern Alps, where
              soaring peaks unfurl into majestic fjords, and witness age-old
              Maori traditions in the midst of a volcanic wonderland. Encounter
              a wealth of unusual creatures in subtropical wildlife sanctuaries,
              and discover vibrant lakeside cities that tell the stories of the
              diverse peoples that call this Pacific nation home.
            </Typography>
            <div>
